...
export default function CourseCard({ course }: { course: Course; key?: string | number }) {
  return (
    <div className="group bg-white rounded-3xl p-7 border-2 border-brand-primary/10 shadow-md hover:shadow-[0_25px_50px_rgba(15,23,42,0.14)] hover:border-brand-secondary hover:-translate-y-2.5 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col h-full cursor-pointer relative overflow-hidden">
